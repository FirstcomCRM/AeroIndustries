...
if ( $model->uphostery_scope && $model->uphostery_type ) {
    $woNumber = Setting::getWorkNo($model->uphostery_type,$model->uphostery_scope,$model->uphostery_order_no);
}
$id = $model->id;
$this->title = 'ARC - COC ' . $woNumber;
