                ...
                <div class="box box-warning">
                    ...
                    <div class="box-body po-table">
                             ...
                             if ( $oldPayment) { ?>
                                ...
                                <?php foreach ( $oldPayment as $oP ) { ?>                            
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                            <a href="?r=general-po/remove-payment&id=<?= $oP->id ?>" title="Delete" aria-label="Delete" data-confirm="Are you sure you want to delete this item?"><span class="glyphicon glyphicon-trash"></span></a>
                                        </div>
                                    </div>
                                <?php } ?>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-7">
                                USD <?= number_format((float)$balance, 2, '.', '') <= 0 ? '0.00' : number_format((float)$balance, 2, '.', '')?> 
                            </div>
                            <div class="col-sm-5">
                                Total Paid: 
                            </div>
                            <div class="col-sm-7">
                                USD <?= number_format((float)$paid, 2, '.', '')?> 
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <?php $form = ActiveForm::begin(); ?>
                                    ...
                                    <?= $form->field($payment, 'general_po_id')->hiddenInput(['value' => $id])->label(false) ?>
