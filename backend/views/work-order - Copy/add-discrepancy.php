<div class="col-sm-12 col-xs-12">    
    <div class="form-group field-workpreliminary-discrepancy">
        ...
        <div class="col-sm-9 col-xs-12">
            <textarea id="workpreliminary-discrepancy" class="form-control" name="WorkPreliminary[discrepancy][]" maxlength="2000" rows="4"></textarea>
...
<div class="col-sm-12 col-xs-12">    
    <div class="form-group field-workpreliminary-corrective">
        ...
        <div class="col-sm-9 col-xs-12">
            <textarea id="workpreliminary-corrective" class="form-control" name="WorkPreliminary[corrective][]" maxlength="2000" rows="4"></textarea>
            <div class="help-block">
            </div>
        </div>
