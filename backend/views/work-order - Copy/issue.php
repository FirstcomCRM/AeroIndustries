                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <?= $form->field($req, 'work_order_id',['template' => 
                                        '<div class="col-sm-3 text-right">{label}</div>
                                        <div class="col-sm-9 col-xs-12">{input}{error}</div> 
                                        {hint}'])->dropDownList($dataWO,
                                        [
                                            'class' => 'select2 form-control selected-wo',
                                            'prompt' => 'Please select Work Order', 
                                            'options' => [isset($_GET['work_order'])&&!empty($_GET['work_order'])?$_GET['work_order']:''  => ['Selected'=>'selected']]
                                        ])->label('Work Order') ?>
                                </div>
                            </div>
                            <hr>
                                ...
                                <table class="table stock-requisition-table stock-out-table" width="100%">
                                    ...
                                    <tbody class="selected-parts">
                                        ...
                                        <tr>
                                            ...
                                            <td width="15%">
                                                <input type="text" name="WorkStockRequisition[qty_issued][]" class="form-control" value="<?=$reqq->qty_issued?$reqq->qty_issued:($reqq->qty_required?$reqq->qty_required:'')?>">
                                            </td>
                                            <td width="11%">
