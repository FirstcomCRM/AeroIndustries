        ...
        <?php $form = ActiveForm::begin(); ?>
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  ...
                  <li><a href="#tab_6" data-toggle="tab">Worker</a></li>
                                ...
                                <div class="col-xs-12">
                                    <div class="">
                                        ...
                                        <div class="box-body ">
                                            ...
                                            <div class="col-sm-12 col-xs-12">
                                               <?= $form->field($data['woAttachment'], 'attachment[]', [
                                ...
                                <div class="col-xs-12">
                                                    ...
                                                    <?php foreach ( $data['currPreAtt'] as $at ) { 
                                                        ...
                                                        <div class="col-sm-3 col-xs-12">
                                                            <a href="<?= 'uploads/wo_pre/' .$at->value ?>" target="_blank"><?= $fileNameOnlyEx[1] ?></a>
                                                             <?= Html::a(' <i class="fa fa-close"></i> ', ['work-order/remove-wopa', 'id' => $at->id], [
                                                                'data' => [
                                                                    'confirm' => 'Are you sure you want to remove this attachment?',
                                                                ],
                                                            ]) ?>
                                                    ...
                                                    <?php foreach ( $data['currDisAtt'] as $at ) { 
                                                        ...
                                                        <div class="col-sm-3 col-xs-12">
                                                            <a href="<?= 'uploads/wo_dis/' .$at->value ?>" target="_blank"><?= $fileNameOnlyEx[1] ?></a>
                                                             <?= Html::a(' <i class="fa fa-close"></i> ', ['work-order/remove-woda', 'id' => $at->id], [
                                                                'data' => [
                                                                    'confirm' => 'Are you sure you want to remove this attachment?',
                                                                ],
                                                            ]) ?>
                                    ...
                                    <div class="box box-warning">
                                        <div class="box-body">
                                            ...
                                            <?php if ( count($data['workPreliminary']) > 0 ) { ?>
                                                <?php foreach ($data['workPreliminary'] as $workPreliminary) { ?>
                                                    <div class="col-sm-12 col-xs-12">    
                                                        <?= $form->field($data['workPreliminary'], 'discrepancy[]', ['template' => '<div class="col-sm-3 text-right">{label}</div>
                                                            <div class="col-sm-9 col-xs-12">{input}{error}{hint}</div>
                                                            '])->textArea(['maxlength' => true,'rows' => 4,]) 
                                                        ?>
                                                    </div>    
                                                    <div class="col-sm-12 col-xs-12">    
                                                        <?= $form->field($data['workPreliminary'], 'corrective[]', ['template' => '<div class="col-sm-3 text-right">{label}</div>
                                                            <div class="col-sm-9 col-xs-12">{input}{error}{hint}</div>
                                                            '])->textArea(['maxlength' => true,'rows' => 4]) 
                                                        ?>
                                                    </div>   
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="box-body ">
                                        ...
                                        <div class="col-sm-12 col-xs-12">    
                                            ...
                                            <div class="form-group field-workorderstaff-staff_group_id">
                                                <input type="hidden" id="workorderstaff-staff_group_id" class="form-control" name="WorkOrderStaff[staff_group_id][]" value="3">
                                                <div class="help-block"></div>
                                            </div>
                                        </div> 
                                        ...
                                        <div class="col-sm-12 col-xs-12">    
                                            ...
                                            <div class="form-group field-workorderstaff-staff_group_id">
                                                <input type="hidden" id="workorderstaff-staff_group_id" class="form-control" name="WorkOrderStaff[staff_group_id][]" value="4">
                                                <div class="help-block"></div>
                                            </div>
                                        </div> 
                                    ...
                                    <div class="box-body technician-add">
                                        ...
                                        <div class="col-sm-12 col-xs-12 tec-<?= $tecc->id ?>">    
                                            ...
                                            <div class="form-group field-workorderstaff-staff_group_id">
                                                <input type="hidden" id="workorderstaff-staff_group_id" class="form-control" name="WorkOrderStaff[staff_group_id][]" value="5">
                                                <div class="help-block"></div>
                                            </div>
                                        </div> 
