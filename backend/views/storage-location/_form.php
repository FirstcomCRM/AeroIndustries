            ...
            <div class="col-xs-12">
                <div class="box">
				    ...
				    <?php $form = ActiveForm::begin(); ?>
					    ...
					    <div class="col-sm-12 col-xs-12">    <?= $form->field($model, 'size', ['template' => '<div class="col-sm-3 text-right">{label}</div>
							<div class="col-sm-9 col-xs-12">{input}</div>
							{hint}
							{error}'])->textInput(['maxlength' => true]) ?>

					    </div>	
					    <div class="col-sm-12 col-xs-12">    <?= $form->field($model, 'status', ['template' => '<div class="col-sm-3 text-right">{label}</div>
							<div class="col-sm-9 col-xs-12">{input}</div>
							{hint}
...
</div><script type="text/javascript"> confi(); </script>
