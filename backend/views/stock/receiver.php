    ...
    <table width="646" cellpadding="32" cellspacing="0" border="0" align="center" class="devicewidth" style="background:white;border-radius:0.5rem;margin-bottom:1rem">
        ...
        <tr class="">
            <td colspan="2">
                <h1>
                    Receiver 
                    <small><?= "RE-" . sprintf("%006d", $reNumber); ?></small> 
                </h1>
                ...
                <div class="box">
                    ...
                    <table class="box-body preview-po" width="100%" >
                        <tr>
                            ...
                            <td>
                            <?php if($isTool) { ?>
                                <?= "GPO-" . sprintf("%006d", $po->purchase_order_no); ?>
                            <?php } else { ?>
                                <?= PurchaseOrder::getPONo($po->purchase_order_no,$po->created) ?>
                            <?php } ?>
                            </td>
                        </tr>
                        <tr>
