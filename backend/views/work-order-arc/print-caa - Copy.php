...
<div class="print-area print-arc">
    ...
    <?php /* col 7  */  ?>
        ...
        <tr>
            ...
            <td align="left" valign="top">
                <div style="text-align:center">
                    <?= $model->new_part_no ? $model->new_part_no : $model->part_no?>
                </div>
            </td>
            <td align="left" valign="top">
                <div style="text-align:center">
            ...
            <td align="left" valign="top">
                <div style="text-align:center" class="capitalize">
                    <?= $model->work_scope == 'Repair' ? 'Repaired' : '' ?>
                    <?= $model->work_scope == 'Inspection' ? 'Inspected' : '' ?>
                    <?= $model->work_scope == 'Production' ? 'Produced' : '' ?>
                </div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2" align="left" valign="top" class="<?= $classLeft ?>">
                17. Name<br>
                <div style="text-align:center">
                    <?= $classLeft == '' ? $inspector->staff_name : ''?>
                </div>
            </td>
            <td colspan="2" align="left" valign="top" class="<?= $classLeft ?>">
                18. Date (d/m/y)<br>
            ...
            <td colspan="2" class="<?= $classRight ?>" align="left" valign="top">
                22. Name<br>
                <div style="text-align:center">
                    <?= $classRight == '' ? $inspector->staff_name : ''?>
                </div>
            </td>
            <td colspan="2" class="<?= $classRight ?>" align="left" valign="top">
                23. Date (d/m/y)<br>
