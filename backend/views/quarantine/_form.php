...
{error}'])->textInput() ?>
    ...
    </div>    <div class="col-sm-12 col-xs-12">    <?= $form->field($model, 'work_order_id', ['template' => '<div class="col-sm-3 text-right">{label}</div>
<div class="col-sm-9 col-xs-12">{input}</div>
{hint}
{error}'])->textInput() ?>
...
{error}'])->textInput(['maxlength' => true]) ?>
    ...
    </div>    <div class="col-sm-12 col-xs-12">    <?= $form->field($model, 'lot_no', ['template' => '<div class="col-sm-3 text-right">{label}</div>
<div class="col-sm-9 col-xs-12">{input}</div>
{hint}
{error}'])->textInput(['maxlength' => true]) ?>
...
{error}'])->textInput() ?>
    ...
    </div>    <div class="col-sm-12 col-xs-12">    <?= $form->field($model, 'reason', ['template' => '<div class="col-sm-3 text-right">{label}</div>
<div class="col-sm-9 col-xs-12">{input}</div>
{hint}
{error}'])->textInput(['maxlength' => true]) ?>
