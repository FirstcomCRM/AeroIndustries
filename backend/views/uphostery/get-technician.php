...
<div class="col-sm-5 col-xs-12">    
	<div class="form-group field-uphosterystaff-staff_name">
		<div class="col-sm-3 text-right"><label class="control-label" for="uphosterystaff-staff_name">Inspector</label></div>
		<div class="col-sm-9 col-xs-12"><select id="uphosterystaff-staff_name" class="form-control" name="UphosteryStaff[staff_name][]">
			<?= $data ?>
		</select>
