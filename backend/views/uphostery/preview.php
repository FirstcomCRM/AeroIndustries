...
<div class="purchase-order-view">
    ...
    <section class="content-header">
        <h1>
            ...
            <h5>Status: <?= $model->deleted == '1' ? 'uphostery deleted' : '' ?><strong class="uppercase"><?= $model->status ?></strong></h5>
        </h1>
        <?php if ( $model->status === 'cancelled' ) { ?>
            This uphostery has been cancelled
        <?php } ?>
    </section>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                  ...
                                                  <ul class="dropdown-menu drop-dropdown generate-dropdown-<?= $wop->id ?>" role="menu">
                                                      <?php if ( $model->status != 'Completed') { ?>
                                                        ...
                                                        <li><?= Html::a( 'Work sheet', Url::to(['work-sheet', 'id' => $model->id,'uphostery_part_id' => $wop->id])) ?></li>
                                                      <?php } ?>
                                                ...
                                                <div class="btn-group">
                                                  ...
                                                  <ul class="dropdown-menu drop-dropdown drop-dropdown-<?= $wop->id ?>" role="menu">
                                                    ...
                                                    <li><?= Html::a( 'Traveler', Url::to(['print-traveler', 'id' => $model->id,'uphostery_part_id' => $wop->id]), array('target' => '_blank')) ?></li>
                                                    ...
                                                    <?php if ( $model->status == 'Completed') { ?>
                                                        ...
                                                        <li><?= Html::a( 'Final Inspection', Url::to(['print-final', 'id' => $model->id,'uphostery_part_id' => $wop->id]), array('target' => '_blank')) ?></li>
                                                         <?php foreach ( $uphosteryArc as $upa ) {  ?>
                                                            <?php if ( $upa->type == 'COC' ) { ?>
                                                                <li><?= Html::a( 'ARC - COC', Url::to(['uphostery-arc/print-coc', 'id' => $model->id, 'uphostery_part_id' => $upp->id]), array('target' => '_blank')) ?></li>
                                                            <?php } ?>
                                                        <?php } ?>
