                      ...
                      <div class="box-body arc-box">  
                         ...
                         <div class="">
                          <div class="box-body">
                            ...
                            <?= $form->field($data['euphosteryPart'], 'pma_used', ['template' => '<div class="col-sm-3 text-right">{label}</div>
                                ...
                                <div class="col-sm-12 col-xs-12">    
                                    ...
                                    <div class="col-sm-12 col-xs-12">    
                                        <?= $form->field($data['euphosteryPart'], 'preliminary_date', ['template' => '<div class="col-sm-3 text-right">{label}</div>
                                            <div class="col-sm-9 col-xs-12">{input}{error}{hint}</div>
