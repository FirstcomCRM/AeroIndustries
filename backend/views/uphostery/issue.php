                                                ...
                                                <tr>
                                                    ...
                                                    <?php 
                                                        ...
                                                        echo TimePicker::widget([
                                                            'name' => 'UphosteryStockRequisition[issued_time][]',
                                                    ...
                                                    <td width="11%">
                                                        <select class="select2" id="so-issued_by" name="UphosteryStockRequisition[issued_by][]">
                                                    ...
                                                    <td width="11%">
                                                        <select class="select2" id="so-issued_to" name="UphosteryStockRequisition[issued_to][]">
                                                            <?php foreach ( Staff::dataStaffId() as $id => $staff ) { ?>
                                                                <option value="<?=$id?>"><?=$staff?></option>
                                                            <?php } ?>
                                                        </select>
