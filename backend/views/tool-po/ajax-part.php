...
<tr class="item-<?= $n ?>">
    <td>    
        <div class="form-group field-toolpodetail-part_id">
            ...
            <input type="hidden" class="form-control" name="ToolPoDetail[<?= $n ?>][part_id]" value="<?= $partId ?>" readonly>
        </div>                                    
    </td>
    <td> 
        <div class="form-group field-qty0">
            <input type="text" class="form-control" id="selected-<?= $n ?>-qty" name="ToolPoDetail[<?= $n ?>][quantity]" value="<?= $qty ?>" readonly onchange="updatePOSubtotal(<?= $n ?>)">
        </div>                                    
    </td>
    <td> 
    ...
    <td> 
        <div class="form-group field-unit">
            <input type="text" class="form-control converted_unit" id="selected-<?= $n ?>-converted_unit" name="ToolPoDetail[<?= $n ?>][unit_price]" value="<?= $converted_unit ?>" readonly onchange="updatePOSubtotal(<?= $n ?>)">
        </div>                                    
    </td>
    <td> 
        <div class="form-group field-unit-m">
            <input type="text" class="form-control" id="selected-<?= $n ?>-unitm" value="<?= $unitM->unit ?>" readonly>
            <input type="hidden" name="ToolPoDetail[<?= $n ?>][unit_id]" value="<?= $unitM->id ?>" readonly>
        </div>                                    
    </td>
    <td> 
        <div class="form-group field-toolpodetail-unit_price">
            <input type="text" class="form-control subTotalGroup" id="selected-<?= $n ?>-subTotal" name="ToolPoDetail[<?= $n ?>][subTotal]" value="<?= $subTotal ?>" readonly>
        </div>
    </td>
    <td> 
