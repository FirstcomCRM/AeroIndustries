...
/* @var $model common\models\ToolPo */
                        ...
                        <div class="row">
                            ...
                            <?php } else { 
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    ...
                                    {hint}
                                    '])->dropDownList($dataSupplier,['class' => 'select2 form-control tpo-supplier'])->label('Supplier') ?>
                                </div>
                            ...
                            <?php if ( !empty ( $currAttachment ) ) { ?>
                                <?php foreach ( $currAttachment as $at ) {
                                    ...
                                    <div class="col-sm-3 col-xs-12">
                                        ...
                                        <?= Html::a(' <i class="fa fa-close"></i> ', ['tool-po/remove-attachment', 'id' => $at->id], [
                                            'data' => [
                        ...
                        <div class="po-form">
                            ...
                            <table width="100%">
                                ...
                                <tbody class="po-body selected-item-list" id="selected-item-list">
                                    <tr>
                                        <td>
                                            <div class="form-group field-toolpodetail-part_id">
                                                <select id="toolpodetail-part_id" class="form-control select2">
                                        ...
                                        <td>
                                            <div class="form-group field-toolpodetail-subtotal">
                                                <input type="text" id="subtotal" class="form-control" placeholder="0.00" readonly>
                                                <div class="help-block"></div>
                                            </div>
                                        </td>
                                        <td valign="top">
                                            <a href="javascript:addTPOItem()"><i class="fa fa-plus"></i> Add</a>
                                        </td>
                                    </tr>
                                    <?php $n = 0; ?>
                                                ...
                                                <tr class="item-<?= $n ?>">
                                                    <td>
                                                        <div class="form-group field-toolpodetail-part_id">
                                                            ...
                                                            <input type="hidden" class="form-control" name="toolpodetail[<?= $n ?>][part_id]" value="<?= $dd->part_id ?>" readonly>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group field-qty0">
                                                            <input type="text" class="form-control" id="selected-<?= $n ?>-qty" name="toolpodetail[<?= $n ?>][quantity]" value="<?= $dd->quantity ?>" readonly onchange="updatePOSubtotal(<?= $n ?>)">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group field-unit">
                                                    ...
                                                    <td>
                                                        <div class="form-group field-unit">
                                                            <input type="text" class="form-control converted_unit" id="selected-<?= $n ?>-converted_unit" name="toolpodetail[<?= $n ?>][unit_price]" value="<?= $dd->unit_price ?>" readonly onchange="updatePOSubtotal(<?= $n ?>)">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group field-unit-m">
                                                            ...
                                                            <input type="hidden" name="toolpodetail[<?= $n ?>][unit_id]" value="<?= $dd->unit_id ?>" readonly>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group field-toolpodetail-unit_price">
                                                            <input type="text" class="form-control subTotalGroup" id="selected-<?= $n ?>-subTotal" name="toolpodetail[<?= $n ?>][subTotal]" value="<?= $dd->subtotal ?>" readonly>
                                                        </div>
                                                    </td>
                                                    <td>
                        ...
                        <div class="po-total">
                            ...
                            <table align="right">
                                <tr>
                                    ...
                                    <td>
                                        <!---<input type="text" id="total" class="form-control" name="ToolPo[subtotal]" placeholder="0.00">--->
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <!---  <input type="text" id="gst" class="form-control" name="ToolPo[gst_rate]" value="7" placeholder="0.00" onchange="getPoTotal()">--->
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <!---  <input type="text" id="totalGST" class="form-control" name="ToolPo[grand_total]" placeholder="0.00">--->
                                        <?php echo $form->field($model, 'grand_total')->textInput(['id'=>'totalGST', 'placeholder'=>'0.00'])->label(false)  ?>
                                        <div class="help-block"></div>
                                        <input type="hidden" id='n' value="0">
                                        <input type="hidden" id='currencyRate' name="ToolPo[conversion]" value="<?= $rate ?>">
                                    </td>
                                </tr>
                            </table>
