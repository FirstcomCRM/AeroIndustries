...
{error}'])->textInput(['maxlength' => true]) ?>
    ...
    </div>    <div class="col-sm-12 col-xs-12">    <?= $form->field($model, 'insert', ['template' => '<div class="col-sm-3 text-right">{label}</div>
<div class="col-sm-9 col-xs-12">{input}</div>
{hint}
{error}'])->textInput(['maxlength' => true]) ?>
...
{error}'])->textInput() ?>
    ...
    </div>    <div class="col-sm-12 col-xs-12">    <?= $form->field($model, 'udpated_by', ['template' => '<div class="col-sm-3 text-right">{label}</div>
<div class="col-sm-9 col-xs-12">{input}</div>
{hint}
{error}'])->textInput() ?>
