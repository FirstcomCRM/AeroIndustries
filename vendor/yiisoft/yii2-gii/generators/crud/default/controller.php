...
class <?= $controllerClass ?> extends <?= StringHelper::basename($generator->baseControllerClass) . "\n" ?>
{
    ...
    public function behaviors()
    {
        ...
        foreach ( $userGroupArray as $uGId => $uGName ){ 
            $permission = UserPermission::find()->where(['controller' => '<?= $modelClass ?>'])->andWhere(['user_group_id' => $uGId ] )->all();
            $actionArray = [];
...
?>
     ...
     * @return mixed
     */
    public function actionPreview(<?= $actionParams ?>)
    {
    ...
    /**
     * Deletes an existing <?= $modelClass ?> model by changing the delete status to 1 .
     * If deletion is successful, the browser will be redirected to the 'index' page.
     * <?= implode("\n     * ", $actionParamComments) . "\n" ?>
     * @return mixed
     */
    public function actionRemove(<?= $actionParams ?>)
    {
