...
/**
 * SearchWorkOrderSub represents the model behind the search form about `common\models\WorkOrderSub`.
 */
class SearchWorkOrderSub extends WorkOrderSub
{
    /**
     * @inheritdoc
     */
