...
/**
 * SearchGeneralPo represents the model behind the search form about `common\models\GeneralPo`.
 */
class SearchGeneralPo extends GeneralPo
{
    public $currency;
    public $supplier;
    ...
    public function search($params)
    {
        ...
        $dataProvider->query->where(['<>','general_po.deleted', 1]);
