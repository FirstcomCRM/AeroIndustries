...
class Stock extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['supplier_id', 'purchase_order_id','part_id', 'hour_used','receiver_no','storage_location_id','unit_id','sub_unit_id','currency_id'], 'integer'],
            [['unit_price','usd_price','freight','quantity'], 'number'],
            [['expiration_date','received','total_quantity','last_cali', 'status', 'shelf_life','next_cali'], 'safe'],
    ...
    */
    ...
    public static function saveStock($id,$model,$previousNo) {
        $data = array();
        $poNo = PurchaseOrder::getPONoById($id);
